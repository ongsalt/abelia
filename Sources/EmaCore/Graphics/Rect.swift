public struct Rect: Sendable {
    ...
    public init(
        topLeft: Position<Float>, size: Size<Float>
    ) {
        self.top = topLeft.y
        self.left = topLeft.x
        self.width = size.x
    ...
    public init(
        center: Position<Float>, size: Size<Float>
    ) {
    ...
    public var center: Position<Float> {
        Position(left + width / 2, top + height / 2)
    }

    public var topLeft: Position<Float> {
        get {
            Position(left, top)
        }
        set {
    ...
    public func offset(_ offset: Position<Float>) -> Rect {
